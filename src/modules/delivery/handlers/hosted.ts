...
export class HostedDeliveryHandler implements DeliveryHandler<"hosted"> {
  ...
  async onGranted(
    ...
    // Manual Hosted lands in status='pending' with provisioning_state='pending' and an open 'provision' task
    const [task] = await tx
...
export const hostedDeliveryHandler = new HostedDeliveryHandler();
